...
const About = () => {
  ...
  <div className="flex flex-col md:flex-row justify-between items-center my-32 ml-10">
    ...
    <div className="md:w-1/2 md:ml-4 text-[20px] bg-gradient-to-r from-[#EAF9FF] to-[#8E9A9A] bg-clip-text text-transparent">
      <p>
        At Custos Diretriz, we are dedicated to revolutionizing safety <br />and security through innovative protocol platforms.
      </p>
      <br />
      <p>
        Our mission is to empower individuals and communities to <br />effectively address crime scene witnessing and streamline <br /> agreement systems.
      </p>
    </div>
  </div>
</div>
  ...
  <div className="text-left mt-4"> {/* Adds some margin above the text paragraphs */}
    <p className="text-[20px] mb-4">
      By leveraging technology and collaboration, we strive to <br />build a world where everyone feels empowered to make a <br /> difference in their communities.
    </p>
    <br />
    <p className="text-[1em] mb-4">
      We envision a safer and more transparent society where <br />individuals have the tools and resources they need to contribute to <br /> crime prevention and intervention efforts.
    </p>
  </div>
</div>
...
<div className="flex flex-col items-center justify-center bg-gradient-to-r from-[#EAF9FF] to-[#8E9A9A] bg-clip-text text-transparent">
  <div className="text-center p-8 bg-transparent rounded shadow-lg mt-20">
    <p className="md:text-[50px] text-[30px] mb-2 bg-gradient-to-r from-[#0094FF] to-[#A02294] bg-clip-text text-transparent">Reach out to us</p>
    <p className="text-[20px] mb-4">
