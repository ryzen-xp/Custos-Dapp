        ...
        <div className="bg-[#130316] w-full h-full py-4">
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                ...
                <div className="mb-4">
                    ...
                    <input type="text" id="secondPartyAddress" name="secondPartyAddress" value={secondPartyAddress} onChange={(e) => setSecondPartyAddress(e.target.value)} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-[#090909] focus:ring-[#c92eff] focus:border-[#c92eff] sm:text-sm p-3" />
                </div>
                <div className="mb-4">
                    <label htmlFor="firstPartyName" className="block text-sm font-medium text-[#c92eff]">First Party Name</label>
                    <input type="text" id="firstPartyName" name="firstPartyName" value={firstPartyName} onChange={(e) => setFirstPartyName(e.target.value)} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#c92eff] focus:border-[#c92eff] sm:text-sm text-[#090909] p-3" />
                </div>
                <div className="mb-4">
                    <label htmlFor="firstPartyValidId" className="block text-sm font-medium text-[#c92eff]">First Party Valid ID</label>
                    <input type="text" id="firstPartyValidId" name="firstPartyValidId" value={firstPartyValidId} onChange={(e) => setFirstPartyValidId(e.target.value)} className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-[#c92eff] text-[#090909] focus:border-[#c92eff] sm:text-sm p-3" />
                </div>
