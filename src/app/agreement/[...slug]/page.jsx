...
const Page = ({ params }) => {
  ...
  return (
    <div className="p-6 text-base space-y-4 bg-red-400 text-[#EAFBFF] w-screen overflow-clip flex flex-col">
      ...
      <div className='w-full px-3 flex flex-row md:flex-col gap-3'>
        <span className="">Agreement Type</span>
        <span className="text-[0.8em] w-fit flex text-wrap font-bold bg-gradient-to-r br border-slate-800 px-2 py-[0.8] border from-[#19B1D2] to-[#0094FF] bg-clip-text text-transparent">
          ...
          <span className="br w-fit overflow-hidden flex border-slate-800 px-2 py-[0.8] border text-[0.7em] text-[#9B9292] whitespace-nowrap overflow-ellipsis">
